...
customContextMenu:function(a){var b={enabled:!0},c=this.getFieldValue("VAR");b.text=this.contextMenuMsg_.replace("%1",c),c=goog.dom.createDom("field",null,c),c.setAttribute("name","VAR"),c=goog.dom.createDom("block",null,c),c.setAttribute("type",this.contextMenuType_),b.callback=Blockly.ContextMenu.callbackFactory(this,c),a.push(b)}},Blockly.Blocks.variables_set={init:function(){this.jsonInit({message0:Blockly.Msg.VARIABLES_SET,args0:[{type:"field_variable",name:"VAR",variable:Blockly.Msg.VARIABLES_DEFAULT_NAME},{type:"input_value",name:"VALUE"}],previousStatement:null,nextStatement:null,colour:Blockly.Blocks.variables.HUE,tooltip:Blockly.Msg.VARIABLES_SET_TOOLTIP,helpUrl:Blockly.Msg.VARIABLES_SET_HELPURL}),this.contextMenuMsg_=Blockly.Msg.VARIABLES_SET_CREATE_GET},contextMenuType_:"variables_get",customContextMenu:Blockly.Blocks.variables_get.customContextMenu},jQuery.fn.blockly=function(a){var b,c,d=$.extend({codeTypes:[],toolBoxXMLText:null,classBlocklyCodeContent:"blockly_code_content",media:"media/"},a),e=this,f=this.attr("id"),g=function(){for(var a=d.codeTypes.length-1;a>=0;a--)"blocks"!==d.codeTypes[a].name&&e.after('<pre id="content_'+d.codeTypes[a].name+'" class="'+d.classBlocklyCodeContent+'" style="position:absolute;"/>');e.after('<textarea id="content_xml" class="'+d.classBlocklyCodeContent+'" style="position:absolute;" readonly/>');var c=Blockly.Xml.textToDom(d.toolBoxXMLText);b=Blockly.inject(f,{grid:{spacing:25,length:3,colour:"#ccc",snap:!0},media:d.media,rtl:!1,toolbox:c,zoom:{controls:!0,wheel:!0}}),i("blocks"),h(),Blockly.svgResize(b)},h=function(){var a={height:e.height(),width:e.width(),x:e.offset().left,y:e.offset().top};$("."+d.classBlocklyCodeContent).each(function(b,c){$(this).css({top:"0px",left:a.x+"px",height:a.height+"px",width:a.width+"px",overflow:"hidden",marginBottom:0})})},i=function(a){c=a,j(),Blockly.svgResize(b),$("."+d.classBlocklyCodeContent).each(function(a,b){$(this).css("visibility","hidden")}),$("#content_"+a).css("visibility","visible"),"blocks"==a?b.setVisible(!0):b.setVisible(!1)},j=function(){if("javascript"==c){var a=Blockly.JavaScript.workspaceToCode(b);$("#content_javascript").html(a),"function"==typeof blocklyPrettyPrintOne&&(a=blocklyPrettyPrintOne(a,"js"),$("#content_javascript").html(a))}else if("xml"==c){var d=Blockly.Xml.workspaceToDom(b),e=Blockly.Xml.domToPrettyText(d);$("#content_xml").val(e)}};return $(window).on("resize",function(){h()}),g(),this.show=function(a){i(a)},this.resize=function(){i("blocks"),h(),Blockly.svgResize(b)},this.hide=function(){b.setVisible(!1)},this.getXML=function(){var a=Blockly.Xml.workspaceToDom(b);return Blockly.Xml.domToPrettyText(a)},this.setXML=function(a){var c=Blockly.Xml.textToDom(a);Blockly.Xml.domToWorkspace(c,b)},this};